    ...
    return (
        <React.Fragment>
            <div className='w-[100%] h-[100vh] overflow-hidden md:flex justify-center md:items-center md:bg-[#BB8A52]'>
                ...
                {/* ==========================  Sign In ================================ */}
                <div className={`signin-body w-[100%] h-[90%] bg-[#6D9773] rounded-br-[250px] flex flex-col justify-center absolute left-full ${isClicked ? 'move' : ''} ${isClickedTwice ? '' : 'move'}`}>
                <div className='w-[90%] mx-auto h-[70%] '>
                ...
                <div className='w-[80px] h-[80px] bg-[#0C3B2E] cursor-pointer rounded-full absolute bottom-[-3%] left-[2%] flex justify-center items-center' onClick={moveBack}>
                            <p className='font-lato text-white font-[700]'>Sign in</p>
                </div>
                </div>
            </div>
