...
const NavBar = () => {
  return (
    <div className=' flex items-center justify-between px-8 gap-6 '>
      ...
      <h1 className='text-[#BB8A52] font-bold text-[25px] font-lato font-[700]'>Dashboard</h1>
      <div className='relative'>
      <input 
        type="search" 
        name="search" 
        placeholder='Search' 
        className='w-[300px] outline-none pl-10 pr-3 py-2 bg-gray-300  font-quick rounded-full text-[#0C3B2E] font-bold' 
      />
   ...
   <IoIosNotificationsOutline size={24} className='cursor-pointer text-[#0C3B2E]' />
   </div>
   <div className='flex items-center gap-3'>
    <img src={heather} className='w-[40px] h-[40px] rounded-full' alt="" />
    <h1 className='font-bold text-[#0C3B2E] text-[20px] font-rubik'>Tola</h1>
    </div>
    </div>
   </div>
  )
